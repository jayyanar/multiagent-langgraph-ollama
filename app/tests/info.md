...
**Build a dedicated Overdraft Fee Review Tool** that can be plugged into the orchestrator. This tool will encapsulate UC-2-specific logic for running-balance calculations, fee-eligibility checks, and refund computation, reducing numeric errors and boosting accuracy.
